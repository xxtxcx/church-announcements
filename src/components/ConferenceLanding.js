...
const FORMAT_LABELS = {
  "": "—",
  "fri-sat-no": "П'ятниця + Субота, без обідів - 700 грн",
  "fri-sat-lunch": "П'ятниця + Субота, з обідами - 1300 грн"
};
...
const SPEAKERS = [
  ...
  },
  {
    ...
    bio: "Єпископ, старший пастор церкви «Джерело життя». Його служіння характеризується надзвичайними дарами вчительства та церковного управління, спрямованими на спорядження й об’єднання служителів задля поширення впливу Царства Божого. Разом з дружиною Іриною виховують Мартина та Тею, та з 2015 року ведуть церкву «Джерело життя» м.Львів",
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Вартість залежить від формату: П'ятниця + Субота, без обідів - 700 грн. П'ятниця + Субота, з обідами - 1300 грн."
  },
  {
    ...
    <div className="conference-page-wrap">
      ...
      >
        ...
        <div className="max-w-[390px] mx-auto w-full px-4 sm:px-6 relative pb-24">
          ...
          >
            <div className="relative">
              ...
              <div className="space-y-6 pl-5">
                <h2
                  className="conference-words-title text-white uppercase w-full"
          ...
          <section
            id="schedule"
            className="py-20 px-4 flex flex-col items-center gap-[50px]"
          >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="fri-sat-no">
                      П&apos;ятниця + Субота, без обідів - 700 грн
                    </option>
                    <option value="fri-sat-lunch">
                      П&apos;ятниця + Субота, з обідами - 1300 грн
                    </option>
                  </select>
                  <ChevronDown className="absolute right-0 top-1/2 -translate-y-1/2 w-5 h-5 text-white/50 pointer-events-none" />
                </div>
        ...
        {(!showIntro || introStep >= 6) && (
          ...
          >
            <div
              className="conference-nav-pill flex items-center min-h-[77px] max-w-[calc(100vw-2rem)] w-full rounded-[147px] border-2 border-white overflow-hidden"
              style={grainStyle}
            >
